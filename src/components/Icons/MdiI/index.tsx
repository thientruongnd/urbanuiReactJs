...
class MdiIconsComponent extends React.Component <{}, isState> {
    constructor(props: {}) {
        super(props);
        this.state = {
            isState: false,
				        ...
				        <div className="card">
					        <div className="card-body">
						        <div className="row icons-list">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-account-location" /> mdi mdi-account-location
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-account-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-account-settings-variant" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-amazon-clouddrive" /> mdi mdi-amazon-clouddrive
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-apple-mobileme " /> mdi mdi-apple-mobileme
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-appnet" /> mdi mdi-appnet
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-compress" /> mdi mdi-arrow-compress
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-compress-all" /> mdi mdi-arrow-compress-all
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-down-bold-circle-outline" /> mdi
								        mdi-arrow-down-bold-circle-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-down-bold-hexagon-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-down-drop-circle-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-left-bold-circle-outline" /> mdi
								        mdi-arrow-left-bold-circle-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-left-bold-hexagon-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-left-drop-circle-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-right-bold-circle" /> mdi
								        mdi-arrow-right-bold-circle
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-right-bold-circle-outline" /> mdi
								        mdi-arrow-right-bold-circle-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-right-bold-hexagon-outline" /> mdi
								        mdi-arrow-right-bold-hexagon-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-right-drop-circle" /> mdi
								        mdi-arrow-right-drop-circle
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-right-drop-circle-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-up-bold-circle-outline" /> mdi
								        mdi-arrow-up-bold-circle-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-up-bold-hexagon-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-arrow-up-drop-circle-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-PolluxUI" /> mdi mdi-PolluxUI
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-bell" /> typcn typcn-bell
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-bell-off" /> typcn typcn-bell-off
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-bell-outline" /> typcn typcn-bell-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-bell-plus" /> typcn typcn-bell-plus
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-bell-ring" /> typcn typcn-bell-ring
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-bell-ring-outline" /> typcn typcn-bell-ring-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-bell-sleep" /> typcn typcn-bell-sleep
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-book-multiple-variant" /> mdi mdi-book-multiple-variant
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-burst-mode" /> mdi mdi-burst-mode
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-calendar-multiple-check" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-chart-scatterplot-hexbin" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-checkbox-blank-circle-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-checkbox-marked-circle-outline" /> mdi
								        mdi-checkbox-marked-circle-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-checkbox-marked-outline" /> mdi
								        mdi-checkbox-marked-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-checkbox-multiple-blank" /> mdi
								        mdi-checkbox-multiple-blank
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-checkbox-multiple-blank-circle" /> mdi
								        mdi-checkbox-multiple-blank-circle
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-checkbox-multiple-blank-circle-outline" /> mdi
								        mdi-checkbox-multiple-blank-circle-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-checkbox-multiple-blank-outline" /> mdi
								        mdi-checkbox-multiple-blank-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-checkbox-multiple-marked" /> mdi
								        mdi-checkbox-multiple-marked
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-checkbox-multiple-marked-circle" /> mdi
								        mdi-checkbox-multiple-marked-circle
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-checkbox-multiple-marked-circle-outline" /> mdi
								        mdi-checkbox-multiple-marked-circle-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-checkbox-multiple-marked-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-cloud-outline-off" /> mdi mdi-cloud-outline-off
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-code-greater-than-or-equal" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-code-less-than-or-equal" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-comment-account-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-comment-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-comment-processing-outline" /> mdi
								        mdi-comment-processing-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-comment-question-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-disk" /> mdi mdi-disk
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-disk-alert" /> mdi mdi-disk-alert
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-mail-open" /> typcn typcn-mail-open
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-mail-open-outline" /> typcn typcn-mail-open-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-mail-outline" /> typcn typcn-mail-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-mail-secure" /> typcn typcn-mail-secure
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-mail-variant" /> typcn typcn-mail-variant
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-flag-outline-variant" /> mdi mdi-flag-outline-variant
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-folder-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-format-horizontal-align-center" /> mdi
								        mdi-format-horizontal-align-center
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-format-horizontal-align-left" /> mdi
								        mdi-format-horizontal-align-left
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-format-horizontal-align-right" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-format-list-bulleted-type" /> mdi
								        mdi-format-list-bulleted-type
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-format-list-numbers" /> mdi mdi-format-list-numbers
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-format-quote" /> mdi mdi-format-quote
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-format-strikethrough-variant" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-format-textdirection-l-to-r" /> mdi
								        mdi-format-textdirection-l-to-r
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-format-textdirection-r-to-l" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-format-vertical-align-bottom" /> mdi
								        mdi-format-vertical-align-bottom
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-format-vertical-align-center" /> mdi
								        mdi-format-vertical-align-center
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-format-vertical-align-top" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-fridge-filled" /> mdi mdi-fridge-filled
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-fridge-filled-bottom" /> mdi mdi-fridge-filled-bottom
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-fridge-filled-top" /> mdi mdi-fridge-filled-top
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-google-circles-communities" /> mdi
								        mdi-google-circles-communities
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-google-circles-extended" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-google-wallet" /> mdi mdi-google-wallet
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-hangouts" /> mdi mdi-hangouts
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-heart-full-outline-box" /> typcn
								        typcn-heart-full-outline-box
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-heart-full-outline-box-outline" /> typcn
								        typcn-heart-full-outline-box-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-heart-full-outline-broken" /> typcn
								        typcn-heart-full-outline-broken
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-heart-full-outline-outline" /> typcn
								        typcn-heart-full-outline-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-heart-full-outline-pulse" /> typcn
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-image-filter-black-white" /> mdi
								        mdi-image-filter-black-white
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-image-filter-center-focus" /> mdi
								        mdi-image-filter-center-focus
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-image-filter-center-focus-weak" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-image-filter-tilt-shift" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-library-plus" /> mdi mdi-library-plus
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-martini" /> mdi mdi-martini
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-th-menu-down" /> typcn typcn-th-menu-down
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-th-menu-left" /> typcn typcn-th-menu-left
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-th-menu-right" /> typcn typcn-th-menu-right
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-th-menu-up" /> typcn typcn-th-menu-up
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-music-note-bluetooth-off" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-nest-protect" /> mdi mdi-nest-protect
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-nest-thermostat" /> mdi mdi-nest-thermostat
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-numeric-0-box-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-numeric-1-box-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-numeric-2-box-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-numeric-3-box-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-numeric-4-box-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-numeric-5-box-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-numeric-6-box-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-numeric-7-box-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-numeric-8-box-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-numeric-9-box-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-numeric-9-plus-box-multiple-outline" /> mdi
								        mdi-numeric-9-plus-box-multiple-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-numeric-9-plus-box-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-outbox" /> mdi mdi-outbox
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-phone-classic" /> mdi mdi-phone-classic
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-phone-locked" /> mdi mdi-phone-locked
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-plus-circle-multiple-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-rdio" /> mdi mdi-rdio
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-read" /> mdi mdi-read
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-readability" /> mdi mdi-readability
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-cog-outline" /> typcn typcn-cog-outline
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="typcn typcn-cog-outline-box" /> typcn typcn-cog-outline-box
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-skip-next-circle-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-skip-previous-circle-outline" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-smoking-off" /> mdi mdi-smoking-off
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-stackexchange" /> mdi mdi-stackexchange
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-stackoverflow" /> mdi mdi-stackoverflow
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-subdirectory-arrow-left" /> mdi
								        mdi-subdirectory-arrow-left
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-subdirectory-arrow-right" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-table-column-plus-after" /> mdi
								        mdi-table-column-plus-after
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-table-column-plus-before" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-tooltip-outline-plus" /> mdi mdi-tooltip-outline-plus
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-unfold-less" /> mdi mdi-unfold-less
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-unfold-more" /> mdi mdi-unfold-more
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-verified" /> mdi mdi-verified
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-vine" /> mdi mdi-vine
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-violin" /> mdi mdi-violin
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-visualstudio" /> mdi mdi-visualstudio
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-weather-partlycloudy" /> mdi mdi-weather-partlycloudy
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-weight-kilogram" /> mdi mdi-weight-kilogrammdi-whatsapp
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-whatsapp" /> mdi mdi-whatsapp
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-wheelchair-accessibility " /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-white-balance-incandescent " /> mdi
								        mdi-white-balance-incandescent
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-white-balance-iridescent" /> mdi
							        ...
							        <div className="col-sm-6 col-md-4 col-lg-3">
								        <i className="mdi mdi-youtube-play" /> mdi mdi-youtube-play
							        </div>
							        <div className="col-sm-6 col-md-4 col-lg-3">
...
export default MdiIconsComponent;
