...
// @ts-ignore
import face20 from '../../../public/images/faces/face20.jpg';

interface isState{
	isState: boolean
}

class Home extends React.Component <{}, isState> {
    constructor(props: {}) {
        super(props);
        this.state = {
            isState: false,
			        ...
			        <div className="col-xl-4 grid-margin stretch-card">
				        <div className="card">
					        ...
					        <div className="card-body">
						        ...
						        <div
							        className="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3 mt-4"
						        >
						        ...
						        <div className="card newsletter-card bg-gradient-warning">
							        <div className="card-body">
								        ...
								        >
									        ...
									        <form
										        className="form d-flex flex-column align-items-center justify-content-between w-100"
									        >
							        ...
							        <div className="card-body">
								        <div className="row align-items-center h-100">
									        ...
									        <div className="col-md-8">
										        ...
										        <div
											        className="d-flex align-items-center justify-content-between info pt-2"
										        >
											        <div>
		        ...
		        <div className="row">
			        <div className="col-md-4 grid-margin stretch-card">
				        <div className="card">
					        <div className="card-body">
						        <div
							        className="d-flex align-items-center justify-content-between justify-content-md-center justify-content-xl-between flex-wrap mb-4"
						        >
							        <div>
